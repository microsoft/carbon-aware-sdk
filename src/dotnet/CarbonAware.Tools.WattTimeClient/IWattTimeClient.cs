...
namespace CarbonAware.Tools.WattTimeClient
{
    ...
    public interface IWattTimeClient
    {
        ...
        /// </summary>
        public Task<IEnumerable<GridEmissionDataPoint>> GetDataAsync(string balancingAuthority, string startTime, string endTime);
        ...
        /// </summary>
        public Task<IEnumerable<Forecast>> GetForecastByDateAsync(string balancingAuthority, string startTime, string endTime);
