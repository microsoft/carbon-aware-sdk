...
- Access to one (or all) of the supported external data APIs
  ...
  - CO2 Signal account - See
    [instruction on CO2 Signal](https://www.co2signal.com/#Subscriber-Email) for
    details.
...
[CO2 Signal](https://www.co2signal.com/) are supported. To use WattTime data or
Electricity Maps data, you'll need to acquire a license from them and set the
...
set when you use WattTime or ElectricityMaps or CO2 Signal as a data source.
